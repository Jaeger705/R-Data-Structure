...
2.  In the above matrix that you creates, print the value 5 by indexing in to the matrix.
...
4.  Print the second column of both matrices.
    ...
    ```{r}
    # Create matrices
    matrix1 <- matrix(first_vector, nrow=3, byrow=TRUE)
    matrix2 <- matrix(second_vector, nrow=3, byrow=TRUE)

    # Combine into an array
    matrix_array <- array(c(matrix1, matrix2), dim = c(3, 3, 2))

    # Accessing elements and rows/columns as specified
    print(matrix_array[2, 2, 1])  # Value 5 from the first matrix
    print(matrix_array[2, 2, 2])  # Value 5 from the second matrix
    print(matrix_array[3,,1])     # Third row of the first matrix
    print(matrix_array[,2,1])     # Second column of the first matrix
    print(matrix_array[,2,2])     # Second column of the second matrix
